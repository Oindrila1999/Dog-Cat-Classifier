...
def main():
    htmltemp='''<div style="background_color:pink;padding:10px;">
                <h2 style="color:blue;text-align:center;">Dog Cat Classifier</h2>
                </div>'''
    ...
    try:
        ...
        if uploaded_file is not None:
            ...
            model=load_model('dog cat calssifier.h5')
